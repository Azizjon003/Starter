...
const cotrolSearch = async function() {
    ...
    await _modelJs.loadSearchResult(data);
    // const datasearch = model.state.search.results;
    const data1 = _modelJs.PaginationFetch();
    _paginationViewJsDefault.default.render(_modelJs.state.search);
    _resultsviewJsDefault.default.rendr(data1);
};
const PaginationController = async function(page) {
    const data1 = _modelJs.PaginationFetch(page);
    _paginationViewJsDefault.default.render(_modelJs.state.search);
    _resultsviewJsDefault.default.rendr(data1);
};
_paginationViewJsDefault.default.addHandleEvent(PaginationController);
// https://forkify-api.herokuapp.com/v2
_searchViewJsDefault.default.addHandleEvent(cotrolSearch); ///////////////////////////////////////

},{"regenerator-runtime":"dXNgZ","./config.js":"k5Hzs","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/resultsview.js":"4wEfE","./views/PaginationView.js":"9Uw3J"}],"dXNgZ":[function(require,module,exports) {
/**
...
parcelHelpers.export(exports, "PaginationFetch", ()=>PaginationFetch
);
var _regeneratorRuntime = require("regenerator-runtime");
var _config = require("./config");
var _helper = require("./helper");
console.log(_config.STEP);
const state = {
    recipe: {},
    search: {
        results: {},
...
const loadSearchResult = async function(food) {
    try {
        const data = await _helper.getJSON(`https://forkify-api.herokuapp.com/api/v2/recipes?search=${food}`);
        // console.log(data);
...
const PaginationFetch = function(page = state.search.page) {
...
exports.default = new SearchValue();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../img/icons.svg":"cMpiy"}],"9Uw3J":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
<button class="btn--inline pagination__btn--next" id=${currentPage + 1}>
  ...
  <svg class="search__icon">
    <use href="${_iconsSvgDefault.default}#icon-arrow-right"></use>
        ...
        const prevBtn = `<button class="btn--inline pagination__btn--prev" id=${currentPage - 1}>
<svg class="search__icon">
  <use href="${_iconsSvgDefault.default}#icon-arrow-left"></use>
</svg>
<span>Page ${currentPage - 1}</span>
</button>`;
        if (currentPage > 1) this.#parentElement.insertAdjacentHTML('afterbegin', prevBtn);
        if (Pages > currentPage) this.#parentElement.insertAdjacentHTML('afterbegin', nextBtn);
    }
